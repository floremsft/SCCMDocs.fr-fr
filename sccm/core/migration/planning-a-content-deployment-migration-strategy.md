---
title: Migrer du contenu |System Center Configuration Manager
...
##  <a name="a-nameaboutshareddpsinmigrationa-share-distribution-points-between-source-and-destination-hierarchies"></a><a name="About_Shared_DPs_in_Migration"></a> Partager les points de distribution entre les hiérarchies source et de destination  
...
###  <a name="a-namebkmkupgradessa-planning-to-upgrade-configuration-manager-2007-secondary-sites"></a><a name="BKMK_UpgradeSS"></a> Planification de la mise à niveau des sites secondaires Configuration Manager 2007  
...
##  <a name="a-nameaboutmigratingcontenta-content-ownership-when-migrating-content"></a><a name="About_Migrating_Content"></a> Propriété du contenu durant la migration de contenu  
