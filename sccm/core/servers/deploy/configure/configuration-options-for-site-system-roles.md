...
**Groupes de limites**  
 ...
 - **Depuis la version 1610**, vous ne pouvez plus configurer **Autoriser un emplacement source de secours pour le contenu**.  Au lieu de cela, vous configurez des relations entre les groupes de limites qui déterminent quand un client peut commencer à rechercher des emplacements sources pour le contenu valides dans d’autres groupes de limites.
