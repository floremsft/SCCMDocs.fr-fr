...
---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>Comment créer des éléments de configuration pour les appareils Windows Phone gérés via Microsoft Intune
...
8.  Dans la page **Paramètres de l’appareil**, sélectionnez le groupe de paramètres à configurer. Pour plus d’informations, consultez [Informations de référence sur les paramètres d’élément de configuration Windows Phone](#windows-phone-configuration-item-settings-reference) dans cette rubrique, puis cliquez sur **Suivant**.  
