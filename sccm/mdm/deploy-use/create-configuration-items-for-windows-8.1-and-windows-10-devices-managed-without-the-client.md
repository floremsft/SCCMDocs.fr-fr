...
---
# <a name="create-configuration-items-for-windows-81-and-windows-10-devices-managed-with-intune"></a>Créer des éléments de configuration pour les appareils Windows 8.1 et Windows 10 gérés via Microsoft Intune
...
|------------------|-------------|  
|**Capture d'écran**|Permet de prendre une capture d'écran de l'affichage de l'appareil.<br> (Windows 10 uniquement)|  
|**Envoi des données de diagnostic**|Autorisez l'envoi des journaux d'application.<br>(Windows 8.1 uniquement)|  
|**Envoi des données de diagnostic (Windows 10)**|Autorisez l'envoi des journaux d'application.<br>(Windows 10 uniquement)|  
|**Géolocalisation**|Autorisez l'appareil à utiliser les informations des services d'emplacement.<br>(Windows 10 uniquement)|  
|**Copier et coller**|Utilisez le copier-coller pour transférer des données entre les applications.<br>(Windows 10 uniquement)|
|**Réinitialisation aux paramètres d’usine**|Contrôle si l’utilisateur peut réinitialiser son appareil aux paramètres d’usine.|
...
|Paramètre|Détails|  
|-------------|-------------|  
|**Autoriser le navigateur web**|Autoriser l’utilisation du navigateur web sur l’appareil.<br>(Windows 10 uniquement)|  
...
###  <a name="internet-explorer"></a>Internet Explorer  
 Ces paramètres concernent uniquement les appareils exécutant Windows 8.1.  
...
|**Autoriser l’envoi du trafic intranet vers Internet Explorer**|Permet aux utilisateurs d’ouvrir des sites web intranet dans Internet Explorer.|  
...
|**Fichiers surveillés**|Si vous avez activé **Surveiller l’activité des fichiers et des programmes**, vous pouvez ensuite choisir s’il faut surveiller les fichiers entrants, les fichiers sortants ou tous les fichiers.|
...
|**Autoriser l’accès à l’interface utilisateur du client**|Détermine si l’interface utilisateur de Windows Defender est masquée aux utilisateurs finaux. Quand ce paramètre est changé, il prend effet lors du redémarrage suivant de l’ordinateur de l’utilisateur final.|
...
|**Planifier une analyse rapide quotidienne**|Permet de planifier une analyse rapide qui se produit tous les jours à l’heure que vous sélectionnez.|
...
|**Analyser les lecteurs mappés**|Permet à Defender d’analyser les fichiers sur un lecteur réseau mappé.<br>Si les fichiers sur le disque sont en lecture seule, Defender ne peut pas y supprimer les logiciels malveillants détectés.|
|**Analyser les fichiers ouverts à partir de dossiers partagés sur le réseau**|Permet à Defender d’analyser les fichiers sur des lecteurs réseau partagé (par exemple ceux qui sont accessibles à partir d’un chemin UNC).<br>Si les fichiers sur le disque sont en lecture seule, Defender ne peut pas y supprimer les logiciels malveillants détectés.|
...
|**Compte Microsoft**|Autorisez l'utilisation d'un compte Microsoft sur l'appareil.<br>(Windows 10 uniquement)|  
...
|Nom du paramètre|Détails|  
|------------------|-------------|  
|**Installation du fichier non signé**|Autorise le chargement des fichiers non signés.<br>(Windows 10 uniquement)|  
|**Applications non signées**|Autorise le chargement des applications non signées.<br>(Windows 10 uniquement)|  
|**Messagerie SMS et MMS**|Autorisez les messages SMS et MMS à partir de l'appareil.<br>(Windows 10 uniquement)|  
|**Stockage amovible**|Autorisez l'utilisation du stockage amovible, comme une carte SD sur l'appareil.<br> (Windows 10 uniquement)|  
|**Appareil photo**|Autorisez l'utilisation de l'appareil photo.<br>(Windows 10 uniquement)|  
|**Communication en champ proche (NFC)**|Autorisez la communication à l'aide de NFC sur l'appareil.<br> (Windows 10 uniquement)|  
|**Mode antivol**|Détermine si le mode antivol de Windows 10 est activé.<br>(Windows 10 uniquement)|
|**Autoriser la connexion USB**|Contrôle si les appareils peuvent accéder à des dispositifs de stockage externes via une connexion USB.<br>(Windows 10 uniquement)|  
|**Fichier de profil**|Configure un profil VPN de profil pour les appareils Windows RT.<br>(Windows 8 uniquement)|  
|**Nom du profil**|Configure un profil VPN de profil pour les appareils Windows RT.<br>(Windows 8 uniquement)|  
|**Profil pour tous les utilisateurs**|Configure un profil VPN de profil pour les appareils Windows RT.<br>(Windows 8 uniquement)|  
...
|Nom du paramètre|Détails|  
|------------------|-------------|  
|**Chiffrement de la carte de stockage**|Exigez le chiffrement des cartes de stockage utilisées avec l'appareil.<br>(Windows 10 uniquement)|  
|**Chiffrement des fichiers sur l’appareil**|Exige que les fichiers soient chiffrés sur le périphérique.|  
|**Demander la signature des courriers électroniques**|Requiert la signature des messages électroniques avant leur envoi.<br>(Windows 10 uniquement)|  
|**Algorithme de signature**|Sélectionnez l’algorithme de signature pour les messages électroniques signés.<br>(Windows 10 uniquement)|  
|**Demander le chiffrement des courriers électroniques**|Requiert le chiffrement des messages électroniques avant leur envoi.<br>(Windows 10 uniquement)|  
|**Algorithme de chiffrement**|Sélectionnez l’algorithme de chiffrement des messages électroniques.<br>(Windows 10 uniquement)|  
...
|**Configuration manuelle du Wi-Fi**|Contrôle si l’utilisateur peut configurer ses propres connexions Wi-Fi ou s’il peut utiliser seulement des connexions configurées par un profil Wi-Fi.|  
...
|**Pare-feu réseau**|Active ou désactive le pare-feu Windows.<br>(Windows 8.1 uniquement)|  
...
|**Mises à jour (Windows 10)**|Choisissez le mode de téléchargement des mises à jour logicielles Windows sur les ordinateurs. Par exemple, vous pouvez télécharger automatiquement les mises à jour, mais permettre à l'utilisateur de choisir à quel moment les installer.<br>(Windows 10 uniquement)|  
|**Jour d’installation**|Choisissez le jour où les mises à jour seront installées.<br>(Windows 10 uniquement)|  
|**Heure d’installation**|Choisissez l’heure à laquelle les mises à jour seront installées.<br>(Windows 10 uniquement)|  
...
|**Fonctionnalités de la version préliminaire**|Permet à Microsoft de déployer des versions préliminaires de paramètres et de fonctionnalités sur le périphérique.<br>(Windows 10 uniquement)|  
|**Installation manuelle du certificat racine**|(Windows 10 uniquement)|
|**Autoriser la désinscription manuelle**|Permet à l'utilisateur de supprimer manuellement le compte d'espace de travail de l'appareil<br>(Windows 10 uniquement)|
